...
full_74x_chs = cms.PSet(
 ...
 tmvaWeights_jteta_0_2p5 = cms.string("RecoJets/JetProducers/data/TMVAClassificationCategory_BDTG.weights_jteta_0_2p5_newNames_newBinning.xml.gz"),
 tmvaWeights_jteta_2p5_2p75 = cms.string("RecoJets/JetProducers/data/TMVAClassificationCategory_BDTG.weights_jteta_2p5_2p75_newNames_newBinning.xml.gz"),
 tmvaWeights_jteta_2p75_3 = cms.string("RecoJets/JetProducers/data/TMVAClassificationCategory_BDTG.weights_jteta_2p75_3_newNames_newBinning.xml.gz"),
 tmvaWeights_jteta_3_5 = cms.string("RecoJets/JetProducers/data/TMVAClassificationCategory_BDTG.weights_jteta_3_5_newNames_oldBinning.xml.gz"),
