...
full_76x_chs = cms.PSet(
 ...
 tmvaWeights_jteta_0_2p5    = cms.string("RecoJets/JetProducers/data/pileupJetId_Eta0to2p5_BDT.weights.xml"),
 tmvaWeights_jteta_2p5_2p75 = cms.string("RecoJets/JetProducers/data/pileupJetId_Eta2p5to2p75_BDT.weights.xml"),
 tmvaWeights_jteta_2p75_3   = cms.string("RecoJets/JetProducers/data/pileupJetId_Eta2p75to3_BDT.weights.xml"),
 tmvaWeights_jteta_3_5      = cms.string("RecoJets/JetProducers/data/pileupJetId_Eta3to5_BDT.weights.xml"),
